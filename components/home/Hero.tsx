    ...
    <section className="relative min-h-screen flex items-center bg-gradient-hero overflow-hidden">
      ...
      <div className="container-xl relative z-10 pt-24 pb-16">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Left — Copy (server-rendered, CSS stagger) */}
          <div>
            <div
              className="animate-fade-up inline-flex items-center gap-2 bg-white/10 backdrop-blur-md border border-white/20 text-white/90 text-sm font-medium px-4 py-2 rounded-full mb-8"
            ...
            <h1
              className="animate-fade-up text-4xl sm:text-5xl lg:text-[3.5rem] font-bold text-white leading-[1.12] mb-6"
            ...
            >
              ...
              <span className="relative inline-block">
                ...
                <span
                  className="absolute -bottom-1 left-0 h-0.5 bg-accent/50 rounded-full animate-expand-width"
            ...
            <p
              className="animate-fade-up text-lg text-white/75 leading-relaxed mb-8 max-w-xl"
            ...
            <div
              className="animate-fade-up flex flex-wrap gap-2 mb-10"
            ...
            <div
              className="animate-fade-up flex flex-col sm:flex-row gap-4 mb-10"
              style={{ animationDelay: "560ms" }}
            >
              <Link
                href="/free-assessment"
                className="btn-primary text-base px-8 py-4 rounded-2xl group flex items-center gap-2 justify-center"
              >
              ...
              <Link
                ...
                className="btn-secondary text-base px-8 py-4 rounded-2xl flex items-center gap-2 justify-center"
              >
            ...
            <div
              className="animate-fade-up flex items-center gap-6 flex-wrap"
            ...
            <div
              className="animate-fade-up mt-5 flex items-center gap-2 text-white/50 text-sm"
          ...
          {/* Right — Visual */}
          <div
            className="animate-slide-left relative flex justify-center lg:justify-end"
            style={{ animationDelay: "400ms" }}
          >
            {/* Floating rating card */}
            <div className="hidden sm:flex animate-float absolute -top-4 -left-4 lg:-left-8 z-20 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl px-4 py-3 items-center gap-3">
              <div className="flex">
                {[...Array(5)].map((_, i) => (
            ...
            <div
              className="hidden sm:block animate-float absolute -bottom-4 -left-4 lg:-left-8 z-20 bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-4 max-w-[220px]"
              style={{ animationDelay: "1s" }}
            >
            ...
            <div className="relative">
              ...
              <Image
                ...
                alt="Students preparing with GetVidya"
                width={540}
                height={480}
                className="rounded-3xl object-cover shadow-2xl relative z-10"
                priority
                fetchPriority="high"
