...
const features: Feature[] = [
  ...
  { title: "AI-Generated Study Plan", desc: "VidyaAI builds your personalized 7-day study plan from your weak subjects, exam target, and current difficulty level.", icon: "🗺️", gradient: "bg-gradient-to-br from-blue-50 to-blue-100", tag: "AI-Powered", tagColor: "bg-blue-100 text-blue-700" },
