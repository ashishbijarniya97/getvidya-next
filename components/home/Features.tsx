...
const features: Feature[] = [
  { title: "GetVidyaAI Adaptive Practice", desc: "AI adjusts question difficulty based on your accuracy. Score 70%+ over 3 sessions and get auto-promoted to the next level.", icon: "🤖", gradient: "bg-gradient-to-br from-violet-50 to-violet-100", tag: "AI-Powered", tagColor: "bg-violet-100 text-violet-700" },
  { title: "AI-Generated Study Plan", desc: "GetVidyaAI builds your personalized 7-day study plan from your weak subjects, exam target, and current difficulty level.", icon: "🗺️", gradient: "bg-gradient-to-br from-blue-50 to-blue-100", tag: "AI-Powered", tagColor: "bg-blue-100 text-blue-700" },
