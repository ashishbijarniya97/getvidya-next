...
const faqs = [
  ...
  { q: "How do I cancel my subscription?", a: "You can cancel your Vidya Pass Pro subscription anytime. Please contact us via email at support@getvidya.in and we'll process your request immediately." },
        ...
        <section className="py-20 bg-slate-50">
          <div className="container-xl max-w-3xl">
            ...
            <div className="text-center mt-12 p-8 card">
              ...
              <p className="text-slate-500 mb-5">Our team is happy to help. Email us anytime.</p>
              <a
                href="mailto:support@getvidya.in"
